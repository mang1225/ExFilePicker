    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.choose_button).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (((CheckBox) findViewById(R.id.only_one_item)).isChecked())
                    intent.putExtra(ExFilePicker.SET_ONLY_ONE_ITEM, true);
                if (((CheckBox) findViewById(R.id.filter_listed)).isChecked())
                    intent.putExtra(ExFilePicker.SET_FILTER_LISTED, new String[]{"jpg", "jpeg"});
                if (((CheckBox) findViewById(R.id.filter_exclude)).isChecked())
                    intent.putExtra(ExFilePicker.SET_FILTER_EXCLUDE, new String[]{"jpg"});
                if (((CheckBox) findViewById(R.id.disable_new_folder_button)).isChecked())
                    intent.putExtra(ExFilePicker.DISABLE_NEW_FOLDER_BUTTON, true);
                if (((CheckBox) findViewById(R.id.disable_sort_button)).isChecked())
                    intent.putExtra(ExFilePicker.DISABLE_SORT_BUTTON, true);
                if (((CheckBox) findViewById(R.id.enable_quit_button)).isChecked())
                ...
                if (checkedChoiceRadio == R.id.choice_type_directories)
